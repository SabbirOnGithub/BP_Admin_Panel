...
// redux actions
import {
	deleteCtaPackageHourly,
	listCtaPackageHourlys,
	saveCtaPackageHourly,
} from "../../../redux/actions/ctaPackageHourlyActions";
...
export default function CtaPackageHourlyScreen() {
	...
	const ctaPackageHourlySave = useSelector(
		(state) => state.ctaPackageHourlySave
	);
	//eslint-disable-next-line
	const {
		loading: loadingSave,
		success: successSave,
		error: errorSave,
	} = ctaPackageHourlySave;
	const ctaPackageHourlyDelete = useSelector(
		(state) => state.ctaPackageHourlyDelete
	);
	//eslint-disable-next-line
	const {
