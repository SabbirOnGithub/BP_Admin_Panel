...
const stripePromise = loadStripe(
	"pk_test_51JH9oLJ708iVAZsoxMt8YdGnYBxxyAbI65tct1LbKy5kWenz6E8CTzJlWr4eOnADslmwaqfTMVqiyZKvlHYJdxX800JOYkQTcB"
);
...
const clientSecret = {
	clientSecret:
		"sk_test_51JH9oLJ708iVAZsoFVngRW8H9UTSd9RXQv2tScPoNhdkQ1mqZ3Jw7Mb0JOGKxhDqPcfytGejEz1ZxJOo6sEmlWVy00NVHupHYu",
};
                  ...
                  <pre>values: {JSON.stringify(values, undefined, 4)}</pre> */}
						...
						<Grid item xs={6}>
							<div className={classes.paymentArea}>
								...
								<div style={{marginTop: 15, width: "45%", display: "none"}}>
