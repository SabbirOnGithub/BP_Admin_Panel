...
export default function PurchaseConsultancy(props) {
    ...
    useEffect( () => {
        setLoading(true);
        axios.get(`${BASE_API_URL}/CtaPackageMonthlyYearly/searchAll`)
        .then( res => {
            setLoading(false);
        ...
        setLoading(true);
        axios.get(`${BASE_API_URL}/CtaPackageHourly/searchAll`)
        .then( res => {
            setLoading(false);
        ...
        setLoading(true);
        axios.get(`${BASE_API_URL}/CtaPackageDaily/searchAll`)
        .then( res => {
            setLoading(false);
    ...
    const handleNextToPaymentScreen = (order) => {
		...
		// companyTypeId: userInfo?.companyTypeId,
		// companySizeId: userInfo?.companySizeId,
        axios.post(`${BASE_API_URL}/CtaFunction`,
            data
            ,{
                ...
                <>
                    ...
                    
                    {
                        !paymentScreen ? (
                            ...
                            <PaymentPurchaseConsultancy></PaymentPurchaseConsultancy>
                        )
                    }
