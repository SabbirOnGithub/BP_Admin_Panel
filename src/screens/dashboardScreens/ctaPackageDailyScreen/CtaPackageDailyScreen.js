...
// redux actions
import {
	deleteCtaPackageDaily,
	listCtaPackageDailys,
	saveCtaPackageDaily,
} from "../../../redux/actions/ctaPackageDailyActions";
...
export default function CtaPackageDailyScreen() {
	...
	const ctaPackageDailyDelete = useSelector(
		(state) => state.ctaPackageDailyDelete
	);
	//eslint-disable-next-line
	const {
